...
pragma solidity ^0.8.0;
contract Finding is ERC20, Ownable {
    ...
    constructor() ERC20("Finding Nemo", "FDN") {
        _mint(msg.sender,7000000000*10**decimals());
        _mint(address(this), 3000000000*10**decimals());
        startSale(block.number, 999999999, 0,2000000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,2000000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
